"""
bot/emojis.py
Quản lý tập trung toàn bộ 56 Custom Application Emojis cho ZerynBot V2.
...
def partial(name: str, fallback_emoji: Optional[str] = None) -> discord.PartialEmoji | str | None:
    """
