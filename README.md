...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/i18n-6%20Languages%20(1589%20Keys)-orange?style=for-the-badge&logo=translate&logoColor=white" alt="i18n 6 Languages">
...
- Bộ nạp RAM O(1) siêu nhanh đồng bộ chuẩn **1589 keys dịch/ngôn ngữ** (100% không lệch key giữa các file).
...
├── i18n.py              # Động cơ dịch đa ngôn ngữ O(1) RAM-cached (1589 keys/file)
...
├── locales/             # 🌐 6 File từ điển ngôn ngữ JSON (vi, en, zh, es, pt, fr) - 1589 keys/file
