...
- 🌐 **[`assets/validate_i18n.py`](https://github.com/namokla2005/ZerynBot/blob/main/.agents/skills/zerynbot_architecture_context/assets/validate_i18n.py)**: Script kiểm thử tự động đồng bộ key i18n (1605 keys).
