...
- **i18n Engine:** RAM-cached O(1) translation lookup engine supporting 6 languages (`vi`, `en`, `zh`, `es`, `pt`, `fr`) with 1656 keys per file.
...
│   ├── vi.json                 # Vietnamese (Default) — 1656 keys
│   ├── en.json                 # English — 1656 keys
│   ├── zh.json                 # Chinese — 1656 keys
│   ├── es.json                 # Spanish — 1656 keys
│   ├── pt.json                 # Portuguese — 1656 keys
│   └── fr.json                 # French — 1656 keys
│
...
1. **i18n Translation Integrity:**
   ...
   - All 6 locale files must always contain the **same number of keys** (currently **1656 keys**). Run `python .agents/skills/zerynbot_architecture_context/assets/validate_i18n.py` to verify key parity.
