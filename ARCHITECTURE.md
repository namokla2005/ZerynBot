...
- **i18n Engine:** RAM-cached O(1) translation lookup engine supporting 6 languages (`vi`, `en`, `zh`, `es`, `pt`, `fr`) with 1604 keys per file.
...
│   ├── vi.json                 # Vietnamese (Default) — 1604 keys
│   ├── en.json                 # English — 1604 keys
│   ├── zh.json                 # Chinese — 1604 keys
│   ├── es.json                 # Spanish — 1604 keys
│   ├── pt.json                 # Portuguese — 1604 keys
│   └── fr.json                 # French — 1604 keys
│
...
1. **i18n Translation Integrity:**
   ...
   - All 6 locale files must always contain the **same number of keys** (currently **1604 keys**). Run `python .agents/skills/zerynbot_architecture_context/assets/validate_i18n.py` to verify key parity.
